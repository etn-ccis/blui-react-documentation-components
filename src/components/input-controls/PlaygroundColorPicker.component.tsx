...
import { PlaygroundColorInput } from '../../types/Playground.types';
...
export const PlaygroundColorPicker: React.FC<PlaygroundColorInput> = (props) => {
    ...
    const validColor = colorIsValid(color, allowMuiColors) || (!props.required && color === '');
    ...
    return (
        <PlaygroundTextField
                            ...
                            <Stack alignItems={'center'}>
                                ...
                                <Box
                                    sx={{
                                        ...
                                        height: 8,
                                        width: 40,
                                        bgcolor: color === '' ? 'text.primary' : validColor ? color : 'common.white',
                                        borderWidth: 1,
                                        borderStyle: 'solid',
                                        borderColor: 'divider',
                                    }}
            ...
            value={color}
            error={!validColor}
            helperText={validColor ? props.description : 'Color value not recognized'}
        />
    );
};
